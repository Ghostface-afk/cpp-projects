/*
Description: program to compute simple interest and discount using functions
...
// simple_interest function prototype
float simple_interest(float rate, int time, int principal);
int final_price(int purchase_amount, float discount);
...
int main() {
    ...
    f_price = final_price(purchase_amount, discount);
